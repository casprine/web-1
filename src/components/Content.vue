<template>
    <div>
      ...
      <defs>
        <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="a"><stop stop-color="#7971ea" offset="0%"></stop><stop stop-color="#DFEBF7" offset="100%"></stop>
        </linearGradient>
      </defs>
